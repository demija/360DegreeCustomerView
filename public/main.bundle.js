...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/validate.service.js.map
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/main.js.map
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/app.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_angular2_flash_messages__ = __webpack_require__(154);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_profile_profile_component__ = __webpack_require__(515);
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_10__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_11__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_14__guards_auth_guard__["a" /* AuthGuard */]],
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/app.module.js.map
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/home.component.js.map
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessagesService.show('Uspješno prijavljeno!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/']);
            }
            else {
                _this.flashMessagesService.show('Greška prilikom prijave! ' + data.msg, { cssClass: 'alert-danger', timeout: 3000 });
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/login.component.js.map
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/navbar.component.js.map
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/profile.component.js.map
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessagesService.show('Uspješno registrovano!', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessagesService.show('Greška!', { cssClass: 'alert-danger', timeout: 3000 });
                _this.router.navigate(['/registracija']);
            }
        });
    };
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/register.component.js.map
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/auth.guard.js.map
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/environment.js.map
...
module.exports = "<h2 class=\"page-header\">Prijava</h2>\n<form (submit)=\"onLoginSubmit()\">\n    <div class=\"form-group\">\n        <label class=\"col-form-label\" for=\"korisnickoimeTextbox\">Korisničko ime</label>\n        <input type=\"text\" [(ngModel)]=\"korisnicko_ime\" name=\"korisnicko_ime\" class=\"form-control\" id=\"korisnickoimeTextbox\" placeholder=\"Unesi korisničko ime\">\n    </div>\n    <div class=\"form-group\">\n        <label class=\"col-form-label\" for=\"lozinkaTextbox\">Lozinka</label>\n        <input type=\"password\" [(ngModel)]=\"lozinka\" name=\"lozinka\" class=\"form-control\" id=\"lozinkaTextbox\" placeholder=\"Unesi lozinku\">\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\">Prijava</button>\n</form>"
...
module.exports = "<div *ngIf=\"user\">\n    <h2 class=\"page-header\">{{ user.ime_prezime }}</h2>\n    <ul class=\"list-group\">\n        <li class=\"list-group-item\">{{ user.korisnicko_ime }}</li>\n        <li class=\"list-group-item\">{{ user.email }}</li>\n    </ul>\n</div>"
...
module.exports = "<form (submit)=\"onRegisterSubmit()\">\n    <div class=\"form-group\">\n        <label for=\"imePrezimeTextbox\">Ime i prezime</label>\n        <input type=\"text\" [(ngModel)]=\"ime_prezime\" name=\"ime_prezime\" class=\"form-control\" id=\"imePrezimeTextbox\" placeholder=\"Unesi ime i prezime\">\n    </div>\n    <div class=\"form-group\">\n        <label for=\"emailTextbox\">Email adresa</label>\n        <input type=\"email\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\" id=\"emailTextbox\" placeholder=\"Unesi e-mail adresu\">\n    </div>\n    <div class=\"form-group\">\n        <label for=\"korisnickoimeTextbox\">Korisničko ime</label>\n        <input type=\"text\" [(ngModel)]=\"korisnicko_ime\" name=\"korisnicko_ime\" class=\"form-control\" id=\"korisnickoimeTextbox\" placeholder=\"Unesi korisničko ime\">\n    </div>\n    <div class=\"form-group\">\n        <label for=\"lozinkaTextbox\">Lozinka</label>\n        <input type=\"password\" [(ngModel)]=\"lozinka\" name=\"lozinka\" class=\"form-control\" id=\"lozinkaTextbox\" placeholder=\"Unesi lozinku\">\n    </div>\n    <div class=\"form-check\">\n        <label class=\"form-check-label\">\n        <input type=\"checkbox\" class=\"form-check-input\">\n        Check me out\n        </label>\n    </div>\n    <button type=\"submit\" class=\"btn btn-primary\">Registracija</button>\n</form>"
...
var AuthService = (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post('http://localhost:3000/korisnici/registracija', user, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.authenticateUser = function (user) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        return this.http.post('http://localhost:3000/korisnici/autentifikacija', user, { headers: headers }).map(function (res) { return res.json(); });
    };
    AuthService.prototype.getProfile = function () {
        ...
        headers.append('Content-Type', 'application/json');
        return this.http.get('http://localhost:3000/korisnici/profil', { headers: headers }).map(function (res) { return res.json(); });
    };
...
//# sourceMappingURL=/home/adem/Projects/360DegreeCustomerView/angular-app/src/auth.service.js.map
