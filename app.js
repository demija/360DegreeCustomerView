...
const poslovnice = require('./routes/poslovnice');
...
const klijentidodatneusluge = require('./routes/klijentidodatneusluge');
...
app.use('/klijentidodatneusluge', klijentidodatneusluge);
